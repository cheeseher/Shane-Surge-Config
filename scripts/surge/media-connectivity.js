const services = [
  { mark: "N", name: "Netflix", url: "https://www.netflix.com/title/81215567", policy: "国际媒体" },
  { mark: "▶", name: "YouTube", url: "https://www.youtube.com/generate_204", policy: "国际媒体" },
  { mark: "◠", name: "Disney+", url: "https://www.disneyplus.com/robots.txt", policy: "国际媒体" },
  { mark: "▷", name: "Prime Video", url: "https://www.primevideo.com/robots.txt", policy: "国际媒体" },
  { mark: "M", name: "Max", url: "https://www.max.com/robots.txt", policy: "国际媒体" },
  { mark: "♪", name: "TikTok", url: "https://www.tiktok.com/robots.txt", policy: "TikTok" },
];
...
function formatLine(item) {
  const label = `${item.mark}  ${item.name.padEnd(nameWidth, " ")}`;
